...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<!--Blog Coupons-->
			<?php get_template_part( 'template-parts/coupons/coupons' ); ?>

			<!--Blog Comments-->
			<?php get_template_part( 'template-parts/comments/comments' ); ?>

			<!--Blog Details-->
			<?php get_template_part( 'template-parts/details/details' ); ?>

			<!--Blog Memorials-->
			<?php get_template_part( 'template-parts/memorials/memorials' ); ?>
							...
							<?php
								if( get_theme_mod( 'enable_pagination', true ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'shoppable-fashion' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'shoppable-fashion' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'shoppable-fashion' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'shoppable-fashion' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'shoppable-fashion' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
